                ...
                <form method="POST" action="{{ route('manager.buses.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <span class="input-group-text bg-dark border-secondary text-white" style="min-width: 80px;">Plate</span>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <span class="input-group-text bg-dark border-secondary text-white" style="min-width: 80px;">Capacity</span>
                    ...
                    {{-- اختيار السائق -د --}}
                    <div class="mb-4">
                        <label class="form-label text-white small text-uppercase fw-bold">Assign Driver (Optional)</label>
                        <div class="input-group">
                            <span class="input-group-text bg-dark border-secondary text-white" style="min-width: 80px;">Driver</span>
                            <select class="form-control form-select ps-3" name="driver_id">
                                <option value="" class="bg-dark text-white-50">-- No Driver Assigned --</option>

                                @foreach( $availabelDrivers as $driver)
                                    <option value="{{ $driver->id }}" class="bg-dark text-white" {{ old('driver_id') == $driver->id ? 'selected' : '' }}>
                                        {{ $driver->user->name }} 
                                        (License: {{ $driver->driver_license_number }})
                                    </option>
                                @endforeach
                        ...
                        <small class="text-white-50 mt-1 d-block" style="font-size: 0.75rem;">
                            Only drivers without an assigned bus are listed here.
                        </small>
                    </div>
